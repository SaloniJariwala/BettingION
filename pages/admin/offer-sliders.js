                    ...
                    <div className="title_bar">
                        <Row className="align-items-center">
                            <Col lg={6}>
                                <div className="title">
                                    <Title>
                                        {adminLanguageData?.offer_slider_page?.page_title?.value}
                                        {isNotAccessible && (
                            ...
                            {isNotAccessible && (
                                <Col lg={6} className="text-lg-end">
                                    <button type="button" className="sec_btn" onClick={() => sliderActionHandler("add")}>
                                        Add Slider <i className="far fa-plus-circle"></i>
                                    </button>
                                </Col>
                            )}
                        </Row>
                    ...
                    {!isNotAccessible ? (
                        ...
                        <>
                            {loading ? (
                                ...
                                <div>
                                    <p className="text-center">No sliders found</p>
                                </div>
                            )}
                        </>
                    )}
