...
const CollectModal = ({ show, setShow, userDetails, type, renderData }) => {
    ...
    const handleSubmit = async (event) => {
        ...
        }&casino=${process.env.NEXT_PUBLIC_CASINO}&remote_id=${userDetails?.userId}&operation_type=collect&amount=${amount}&auth_id=${
    ...
    return (
        <AdminModal show={show} closeModal={handleClose}>
            <h3 className="h3-title modal_title">{adminLanguageData?.common_finance_module?.collect_modal_title?.value}</h3>
