...
const IncreaseModal = ({ show, setShow, userDetails, setFlag }) => {
    ...
    const handleChange = (event, name) => {
        if (name === "collect") {
            ...
            setCollectCheckbox(true);
            setDiscountCheckbox(false);

            if (collectCheckbox === true) {
                setCollectCheckbox(false);
            }
        } else {
            if (event.target.checked) {
    ...
    const handleCredit = async (e) => {
        ...
        await axios
            .get(
                ...
                }&casino=${process.env.NEXT_PUBLIC_CASINO}&amount=${amount}&description=${description}&operationType=${operationType}&sender_id=${
                    ...
                    <div className="form_input_group add_player_credits_info">
                        <div className="d-flex form_checkbox_group">
                            <div className="form_checkbox">
                                <input
                                    ...
                                    onChange={(event) => handleChange(event, "collect")}
                                />
                                <label className="form-check-label" htmlFor="register_charged">
                                    {adminLanguageData?.add_credits_user_modal?.add_credits_modal_register_as_collected?.value}
                                </label>
                            </div>
                            <div className="form_checkbox">
                                <input
                                ...
                                />
                                <label className="form-check-label" htmlFor="register_bonus">
                                    {adminLanguageData?.add_credits_user_modal?.add_credits_modal_register_as_discounted?.value}
                                </label>
                            </div>
                        </div>
                        <div className="form_right_group">
                            ...
                            <textarea
                                ...
                                placeholder={adminLanguageData?.add_credits_user_modal?.add_credits_modal_description_placeholder?.value}
                            ></textarea>
                        </div>
